...
music.push("R&B")
if (music.length%2==1){
    music[Math.floor(music.length/2)]="none"
}
music.splice(Math.floor(music.length/2),0,"classic")
music.unshift("rap","acapella")
console.log(music)

let b = ["Phineas", "Ferb", "Perry", "Doofenschmirtz", "Isabella", "Candace"]
let c = ["Jake", "Finn", "LSP", "Marceline", "Princess Bubblegum", "Lemonheads"]

let e = ["Beemo", ...c, "Lich", "Flame Princess", ]
console.log(e)
